...
const Shop = () => {
  return (
    <div className="shopping">
      ...
      Corporis dolores sit similique! Tempore omnis quibusdam in nam quidem! Aliquam eum tenetur accusamus est quod molestias dolore autem magnam incidunt, sunt laborum commodi odio voluptatem deleniti quidem blanditiis inventore?
      Rerum unde quo vitae beatae? Exercitationem, amet. Distinctio iure ut cumque quaerat. Assumenda iure, id laborum, magnam debitis, at ipsam inventore ducimus dicta ipsum itaque vitae quaerat dolor nostrum nisi!</p>
